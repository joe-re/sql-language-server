...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c327 = function() { varList = []; return true; },
      peg$c328 = function(s) {
            return {
              stmt : s,
              vars: varList
      ...
      peg$c338 = "return",
      peg$c339 = peg$literalExpectation("return", true),
      peg$c340 = ":=",
      peg$c341 = peg$literalExpectation(":=", false),
      peg$c342 = function(val, t, w) {
            return {
              type    : 'delete',
              table   : t,
              where   : w
