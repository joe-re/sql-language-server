...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c231 = "generated",
      peg$c232 = peg$literalExpectation("GENERATED", true),
      peg$c233 = "always",
      peg$c234 = peg$literalExpectation("ALWAYS", true),
      peg$c235 = "by default",
      peg$c236 = peg$literalExpectation("BY DEFAULT", true),
      peg$c237 = "by default on null",
      peg$c238 = peg$literalExpectation("BY DEFAULT ON NULL", true),
      peg$c239 = "identity",
      peg$c240 = peg$literalExpectation("IDENTITY", true),
      peg$c241 = "start",
      peg$c242 = peg$literalExpectation("START", true),
      peg$c243 = "with",
      peg$c244 = peg$literalExpectation("WITH", true),
      peg$c245 = function(val) { return makeKeywordNode(val, location()) },
      peg$c246 = "minvalue",
      ...
      peg$c417 = function() { varList = []; return true; },
      peg$c418 = function(s) {
            return {
              stmt : s,
              vars: varList
      ...
      peg$c421 = function(lt, op, rt, expr) {
            return {
              type    : 'join',
              ltable  : lt, 
              rtable  : rt,
      ...
      peg$c433 = function(with_clause, val, t, w) {
            return {
              type    : 'delete',
              with    : with_clause,
              table   : t,
      ...
      peg$c436 = function(keyword, table, as, select) {
            return {
              type: 'create_table',
              keyword: keyword,
              if_not_exists: null,
      ...
      peg$c437 = function(keyword, if_not_exists_keyword, table, fields) {
            return {
              type: 'create_table',
              keyword: keyword,
      ...
      peg$c438 = function(keyword, table, fields) {
            return {
              type: 'create_table',
              if_not_exists: null,
              keyword: keyword,
      ...
      peg$c440 = function(name, type, constraints) {
          return {
            type: 'field',
            name: name,
            data_type: type,
      ...
      peg$c450 = function(g, opt, data, seq) {
      ...
      peg$c465 = function(keyword, table, command) {
            return {
              type: 'alter_table',
              keyword: keyword,
              table: table,
      ...
      peg$c467 = function(keyword, field) {
            return {
      ...
      peg$c468 = function(keyword) {error('EXPECTED COLUMN NAME')},
      peg$c469 = function(keyword, column) {
            return {
      ...
      peg$c470 = function(keyword, field) {
            return {
  ...
  function peg$parseKW_BY_DEFAULT_ON_NULL() {
    ...
    s0 = peg$currPos;
    if (input.substr(peg$currPos, 18).toLowerCase() === peg$c237) {
